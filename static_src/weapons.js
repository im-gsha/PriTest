      ...
      extraTables: [
        {
          ...
          columns: [C("ダイス2個", "2顆骰"), C("魔術名", "魔術名")],
          rows: [
            [C("1・2／1", "1、2／1"), C("輝石の速つぶて（186頁）", "輝石速彈（186頁）")],
            [C("1・2／2", "1、2／2"), C("輝石の大つぶて（186頁）", "輝石大彈（186頁）")],
            [C("1・2／3", "1、2／3"), C("ほうき星（186頁）", "掃帚星（186頁）")],
            [C("1・2／4", "1、2／4"), C("輝石の流星（186頁）", "輝石流星（186頁）")],
            [C("1・2／5", "1、2／5"), C("渦巻くつぶて（186頁）", "渦捲彈（186頁）")],
            [C("1・2／6", "1、2／6"), C("輝石のアーク（次頁）", "輝石弧光（次頁）")],
            [C("3／1", "3／1"), C("ハイマの砲丸（186頁）", "海馬的砲彈（186頁）")],
            [C("3／2", "3／2"), C("ハイマの大槌（186頁）", "海馬的巨鎚（186頁）")],
            [C("3／3", "3／3"), C("魔力の武器（186頁）", "魔力武器（186頁）")],
            [C("3／4", "3／4"), C("魔力の盾（187頁）", "魔力之盾（187頁）")],
            [C("3／5", "3／5"), C("トープスの力場（187頁）", "托普斯的力場（187頁）")],
            [C("3／6", "3／6"), C("創星雨（187頁）", "創星雨（187頁）")],
            [C("4／1", "4／1"), C("結晶連弾（187頁）", "結晶連彈（187頁）")],
            [C("4／2", "4／2"), C("結晶散弾（187頁）", "結晶散彈（187頁）")],
            [C("4／3", "4／3"), C("ローレッタの大弓（187頁）", "洛蕾塔的大弓（187頁）")],
            [C("4／4", "4／4"), C("ローレッタの絶技（187頁）", "洛蕾塔的絕技（187頁）")],
            [C("4／5", "4／5"), C("ラニの暗月（187頁）", "拉尼的暗月（187頁）")],
            [C("4／6", "4／6"), C("カーリアの返報（187頁）", "卡利亞的回報（187頁）")],
            [C("5／1", "5／1"), C("罪の茨（188頁）", "罪之荊棘（188頁）")],
            [C("5／2", "5／2"), C("罰の茨（185頁）", "罰之荊棘（185頁）")],
            [C("5／3", "5／3"), C("岩盤砕き（185頁）", "岩盤破碎（185頁）")],
            [C("5／4", "5／4"), C("岩盤発破（188頁）", "岩盤爆破（188頁）")],
            [C("5／5", "5／5"), C("夜のつぶて（188頁）", "夜之彈（188頁）")],
            [C("5／6", "5／6"), C("夜の彗星（185頁）", "夜之彗星（185頁）")],
            [C("6／1", "6／1"), C("魔術の輝剣（次頁）", "魔術的輝劍（次頁）")],
            [C("6／2", "6／2"), C("輝剣の円陣（188頁）", "輝劍圓陣（188頁）")],
            [C("6／3", "6／3"), C("カーリアの円陣（188頁）", "卡利亞的圓陣（188頁）")],
            [C("6／4", "6／4"), C("砕け散る結晶（185頁）", "碎裂的結晶（185頁）")],
            [C("6／5", "6／5"), C("放たれる結晶（188頁）", "釋放的結晶（188頁）")],
            [C("6／6", "6／6"), C("結晶の解放（188頁）", "結晶的解放（188頁）")],
          ],
        },
        {
          ...
          rows: [
            ...
            [C("1・2／5", "1、2／5"), C("渦巻くつぶて（186頁）", "渦捲彈（186頁）")],
            [C("1・2／6", "1、2／6"), C("輝石のアーク（次頁）", "輝石弧光（次頁）")],
            [C("3／1", "3／1"), C("カーリアの速剣（次頁）", "卡利亞的速劍（次頁）")],
            [C("3／2", "3／2"), C("カーリアの大剣（188頁）", "卡利亞的大劍（188頁）")],
            [C("3／3", "3／3"), C("カーリアの貫き（188頁）", "卡利亞的貫穿（188頁）")],
            [C("3／4", "3／4"), C("アデューラの月の剣（189頁）", "阿德拉的月之劍（189頁）")],
            [C("3／5", "3／5"), C("夜巫女の霧（189頁）", "夜巫女之霧（189頁）")],
            [C("3／6", "3／6"), C("永遠の暗黒（189頁）", "永遠的暗黑（189頁）")],
            [C("4／1", "4／1"), C("溶岩弾（次頁）", "熔岩彈（次頁）")],
            [C("4／2", "4／2"), C("たぎる溶岩（189頁）", "沸騰的熔岩（189頁）")],
            [C("4／3", "4／3"), C("ゲルミアの怒り（189頁）", "格爾米爾的憤怒（189頁）")],
            [C("4／4", "4／4"), C("ライカードの怨霊（189頁）", "萊卡德的怨靈（189頁）")],
            [C("4／5", "4／5"), C("神託のシャボン（189頁）", "神諭的泡沫（189頁）")],
            [C("4／6", "4／6"), C("神託の大シャボン（189頁）", "神諭的大泡沫（189頁）")],
            [C("5／1", "5／1"), C("重力弾（186頁）", "重力彈（186頁）")],
            [C("5／2", "5／2"), C("星砕き（189頁）", "星辰破碎（189頁）")],
            [C("5／3", "5／3"), C("岩石弾（189頁）", "岩石彈（189頁）")],
            [C("5／4", "5／4"), C("メテオライト（190頁）", "隕石（190頁）")],
            [C("5／5", "5／5"), C("アステール・メテオ（190頁）", "阿斯特爾隕石（190頁）")],
            [C("5／6", "5／6"), C("ティビアの呼び声（190頁）", "提比亞的呼喚（190頁）")],
            [C("6／1", "6／1"), C("輝石の氷塊（190頁）", "輝石冰塊（190頁）")],
            [C("6／2", "6／2"), C("氷の霧（190頁）", "冰之霧（190頁）")],
            [C("6／3", "6／3"), C("氷結の武器（190頁）", "冰結武器（190頁）")],
            [C("6／4", "6／4"), C("ザミエルの氷嵐（190頁）", "扎米爾的冰嵐（190頁）")],
            [C("6／5", "6／5"), C("古き死の怨霊（190頁）", "古老死亡的怨靈（190頁）")],
            [C("6／6", "6／6"), C("爆ぜる霊炎（190頁）", "爆裂的靈炎（190頁）")],
          ],
        },
      ],
    },
      ...
      extraTables: [
        {
          ...
          columns: [C("ダイス2個", "2顆骰"), C("祈祷名", "祈禱名")],
          rows: [
            [C("1／1", "1／1"), C("性急な回復（次頁）", "急促的回復（次頁）")],
            [C("1／2", "1／2"), C("回復（この頁）", "回復（本頁）")],
            [C("1／3", "1／3"), C("大回復（次頁）", "大回復（次頁）")],
            [C("1／4", "1／4"), C("王たる回復（次頁）", "王者的回復（次頁）")],
            [C("1／5", "1／5"), C("影送り（次頁）", "影送（次頁）")],
            [C("1／6", "1／6"), C("暗闇（193頁）", "黑暗（193頁）")],
            [C("2／1", "2／1"), C("魔力防護（193頁）", "魔力防護（193頁）")],
            [C("2／2", "2／2"), C("聖防護（193頁）", "聖防護（193頁）")],
            [C("2／3", "2／3"), C("炎防護（193頁）", "炎防護（193頁）")],
            [C("2／4", "2／4"), C("雷防護（193頁）", "雷防護（193頁）")],
            [C("2／5・6", "2／5、6"), C("王たる聖防護（193頁）", "王者的聖防護（193頁）")],
            [C("3／1", "3／1"), C("黄金樹に誓って（193頁）", "以黃金樹之名（193頁）")],
            [C("3／2", "3／2"), C("黄金の魔力防護（193頁）", "黃金魔力防護（193頁）")],
            [C("3／3", "3／3"), C("黄金の雷防護（193頁）", "黃金雷防護（193頁）")],
            [C("3／4", "3／4"), C("黄金樹の護り（193頁）", "黃金樹的守護（193頁）")],
            [C("3／5", "3／5"), C("黄金樹の回復（193頁）", "黃金樹的回復（193頁）")],
            [C("3／6", "3／6"), C("黄金樹の恵み（193頁）", "黃金樹的恩惠（193頁）")],
            [C("4／1", "4／1"), C("坩堝の諸相・喉袋（194頁）", "坩堝諸相・喉袋（194頁）")],
            [C("4／2", "4／2"), C("坩堝の諸相・尾（194頁）", "坩堝諸相・尾（194頁）")],
            [C("4／3", "4／3"), C("坩堝の諸相・角（194頁）", "坩堝諸相・角（194頁）")],
            [C("4／4", "4／4"), C("エルデの流星（194頁）", "艾爾登的流星（194頁）")],
            [C("4／5", "4／5"), C("黒き剣（194頁）", "黑劍（194頁）")],
            [C("4／6", "4／6"), C("死を正す聖律（194頁）", "矯正死亡的聖律（194頁）")],
            [C("5／1", "5／1"), C("聖律の剣（194頁）", "聖律之劍（194頁）")],
            [C("5／2", "5／2"), C("不易の盾（194頁）", "不易之盾（194頁）")],
            [C("5／3", "5／3"), C("回帰性原理（194頁）", "回歸性原理（194頁）")],
            [C("5／4", "5／4"), C("光輪（次頁）", "光輪（次頁）")],
            [C("5／5", "5／5"), C("三なる光輪（194頁）", "三重光輪（194頁）")],
            [C("5／6", "5／6"), C("ラダゴンの光輪（195頁）", "拉達岡的光輪（195頁）")],
            [C("6／1", "6／1"), C("雷の槍（次頁）", "雷之槍（次頁）")],
            [C("6／2", "6／2"), C("雷撃（195頁）", "雷擊（195頁）")],
            [C("6／3", "6／3"), C("狙いすます雷撃（195頁）", "精準雷擊（195頁）")],
            [C("6／4", "6／4"), C("古竜の雷槍（195頁）", "古龍的雷槍（195頁）")],
            [C("6／5", "6／5"), C("ランサクスの薙刀（195頁）", "蘭薩克斯的薙刀（195頁）")],
            [C("6／6", "6／6"), C("フォルサクスの雷槍（195頁）", "佛薩克斯的雷槍（195頁）")],
          ],
        },
        {
          ...
          rows: [
            [C("1／1", "1／1"), C("性急な回復（次頁）", "急促的回復（次頁）")],
            [C("1／2", "1／2"), C("回復（次頁）", "回復（次頁）")],
            [C("1／3", "1／3"), C("大回復（次頁）", "大回復（次頁）")],
            [C("1／4", "1／4"), C("王たる回復（次頁）", "王者的回復（次頁）")],
            [C("1／5", "1／5"), C("影送り（次頁）", "影送（次頁）")],
            [C("1／6", "1／6"), C("暗闇（193頁）", "黑暗（193頁）")],
            [C("2／1", "2／1"), C("氷の雷槍（195頁）", "冰之雷槍（195頁）")],
            [C("2／2", "2／2"), C("死の雷撃（195頁）", "死亡雷擊（195頁）")],
            [C("2／3", "2／3"), C("雷の武器（195頁）", "雷之武器（195頁）")],
            [C("2／4", "2／4"), C("竜雷の加護（196頁）", "龍雷之加護（196頁）")],
            [C("2／5", "2／5"), C("毒霧（196頁）", "毒霧（196頁）")],
            [C("2／6", "2／6"), C("毒の刃（196頁）", "毒之刃（196頁）")],
            [C("3／1", "3／1"), C("火よ！（196頁）", "火焰！（196頁）")],
            [C("3／2", "3／2"), C("火投げ（次頁）", "投火（次頁）")],
            [C("3／3", "3／3"), C("巨人の火をくらえ（196頁）", "領受巨人之火（196頁）")],
            [C("3／4", "3／4"), C("火よ、降り注げ（196頁）", "火焰降臨（196頁）")],
            [C("3／5", "3／5"), C("悪神の火（196頁）", "惡神之火（196頁）")],
            [C("3／6", "3／6"), C("火よ、焼き尽くせ！（196頁）", "焚燒殆盡！（196頁）")],
            [C("4／1", "4／1"), C("黒炎（次頁）", "黑炎（次頁）")],
            [C("4／2", "4／2"), C("薙ぎ払う黒炎（196頁）", "橫掃黑炎（196頁）")],
            [C("4／3", "4／3"), C("黒炎の儀式（197頁）", "黑炎儀式（197頁）")],
            [C("4／4", "4／4"), C("黒炎の刃（197頁）", "黑炎之刃（197頁）")],
            [C("4／5", "4／5"), C("黒炎の護り（197頁）", "黑炎守護（197頁）")],
            [C("4／6", "4／6"), C("貴種の腹芸（197頁）", "貴種的腹藝（197頁）")],
            [C("5／1・2", "5／1、2"), C("獣爪（197頁）", "獸爪（197頁）")],
            [C("5／3", "5／3"), C("獣の石（次頁）", "獸之石（次頁）")],
            [C("5／4", "5／4"), C("グラングの獣爪（197頁）", "古朗格的獸爪（197頁）")],
            [C("5／5", "5／5"), C("グラングの岩（197頁）", "古朗格的岩石（197頁）")],
            [C("5／6", "5／6"), C("獣の生命（197頁）", "獸之生命（197頁）")],
            [C("6／1", "6／1"), C("蝋たかり（197頁）", "蠟集（197頁）")],
            [C("6／2", "6／2"), C("血炎の爪痕（197頁）", "血炎爪痕（197頁）")],
            [C("6／3", "6／3"), C("血授（198頁）", "血授（198頁）")],
            [C("6／4", "6／4"), C("血炎の刃（198頁）", "血炎之刃（198頁）")],
            [C("6／5", "6／5"), C("蟲糸（198頁）", "蟲絲（198頁）")],
            [C("6／6", "6／6"), C("朱きエオニア（198頁）", "朱紅的伊奧尼亞（198頁）")],
          ],
        },
        {
          ...
          columns: [C("ダイス2個", "2顆骰"), C("祈祷名", "祈禱名")],
          rows: [
            [C("1／1・2", "1／1、2"), C("狂い火（次頁）", "狂火（次頁）")],
            [C("1／3・4", "1／3、4"), C("堪えきれぬ狂い火（198頁）", "難忍的狂火（198頁）")],
            [C("1／5", "1／5"), C("空裂狂火（198頁）", "空裂狂火（198頁）")],
            [C("1／6", "1／6"), C("シャブリリの叫び（198頁）", "夏布利利的吶喊（198頁）")],
            [C("2／1", "2／1"), C("竜炎（次頁）", "龍炎（次頁）")],
            [C("2／2", "2／2"), C("溶岩プレス（198頁）", "熔岩壓（198頁）")],
            [C("2／3", "2／3"), C("輝石プレス（198頁）", "輝石壓（198頁）")],
            [C("2／4", "2／4"), C("腐敗プレス（198頁）", "腐敗壓（198頁）")],
            [C("2／5", "2／5"), C("竜氷（199頁）", "龍冰（199頁）")],
            [C("2／6", "2／6"), C("竜爪（199頁）", "龍爪（199頁）")],
            [C("3／1", "3／1"), C("アギールの炎（199頁）", "阿基爾之炎（199頁）")],
            [C("3／2", "3／2"), C("テオドリックスの溶岩（199頁）", "提歐多里克斯的熔岩（199頁）")],
            [C("3／3", "3／3"), C("スマラグの輝石（199頁）", "斯馬拉格的輝石（199頁）")],
            [C("3／4", "3／4"), C("エグズキスの腐敗（199頁）", "艾格茲基斯的腐敗（199頁）")],
            [C("3／5", "3／5"), C("ボレアリスの氷霧（199頁）", "波瑞亞斯的冰霧（199頁）")],
            [C("3／6", "3／6"), C("グレイオールの咆哮（199頁）", "格雷歐爾的咆哮（199頁）")],
            [C("4／1", "4／1"), C("黒炎（次頁）", "黑炎（次頁）")],
            [C("4／2", "4／2"), C("薙ぎ払う黒炎（196頁）", "橫掃黑炎（196頁）")],
            [C("4／3", "4／3"), C("黒炎の儀式（197頁）", "黑炎儀式（197頁）")],
            [C("4／4", "4／4"), C("黒炎の刃（197頁）", "黑炎之刃（197頁）")],
