  ...
  var SCENARIOS = [
    ...
    },
    {
      ...
      day2: [
        ...
        { pos: 3, suit: "S", rank: "Q", name: { zh: "地變｜山嶺(山頂)", ja: "地変｜山嶺(山頂)", en: "Terrain Shift｜Mountains (Peak)" } },
        { pos: 4, suit: "H", rank: "Q", name: { zh: "地變｜山嶺(山腰)", ja: "地変｜山嶺(中腹)", en: "Terrain Shift｜Mountains (Midslope)" } },
    ...
    },
    {
      ...
      day2: [
        ...
        { pos: 2, suit: "H", rank: "Q", name: { zh: "地變｜諾克拉提歐(最深處)", ja: "地変｜ノクラテオ(最奥)", en: "Terrain Shift｜Noklateo (Depths)" } },
        { pos: 3, suit: "D", rank: "Q", name: { zh: "地變｜諾克拉提歐(市街地)", ja: "地変｜ノクラテオ(市街地)", en: "Terrain Shift｜Noklateo (City)" } },
        { pos: 4, suit: "C", rank: "Q", name: { zh: "地變｜諾克拉提歐(入口)", ja: "地変｜ノクラテオ(玄関口)", en: "Terrain Shift｜Noklateo (Entrance)" } },
    ...
    },
    {
      ...
      day2: [
        ...
        { pos: 2, suit: "S", rank: "Q", name: { zh: "地變｜火口(上層)", ja: "地変｜火口(上層)", en: "Terrain Shift｜Crater (Upper)" } },
        { pos: 3, suit: "D", rank: "Q", name: { zh: "地變｜火口(空洞內)", ja: "地変｜火口(空洞内)", en: "Terrain Shift｜Crater (Cavern)" } },
        { pos: 4, suit: "C", rank: "Q", name: { zh: "地變｜火口(最深處)", ja: "地変｜火口(最奥)", en: "Terrain Shift｜Crater (Depths)" } },
    ...
    },
    {
      ...
      day1: [
        ...
        { pos: 2, suit: "H", rank: "4", name: { zh: "大野營地（隨機）", ja: "大野営地（ランダム）", en: "Main Camp (Random)" } },
        { pos: 3, suit: "H", rank: "5", name: { zh: "遺跡（毒）", ja: "遺跡（毒）", en: "Ruins (Poison)" } },
        { pos: 4, suit: "D", rank: "6", name: { zh: "坑道（2）", ja: "坑道（2）", en: "Tunnel (2)" } },
        { pos: 5, suit: "H", rank: "7", name: { zh: "湖沼（毒）", ja: "湖沼（毒）", en: "Lake (Poison)" } },
        { pos: 6, suit: "H", rank: "9", name: { zh: "封牢（隨機）", ja: "封牢（ランダム）", en: "Sealed Prison (Random)" } },
        { pos: 7, suit: "H", rank: "10", name: { zh: "魔術師之塔", ja: "魔術師塔", en: "Sorcerer's Tower" } },
        { pos: 8, suit: "C", rank: "K", name: { zh: "教會", ja: "教会", en: "Church" } },
        { pos: 9, suit: "D", rank: "K", name: { zh: "教會", ja: "教会", en: "Church" } },
      ],
      day2: [
        { pos: 1, suit: "H", rank: "2", name: { zh: "大教會（隨機）", ja: "大教会（ランダム）", en: "Grand Cathedral (Random)" } },
        { pos: 2, suit: "S", rank: "3", name: { zh: "小砦（隨機）", ja: "小砦（ランダム）", en: "Small Fort (Random)" } },
        { pos: 3, suit: "C", rank: "4", name: { zh: "大野營地（隨機）", ja: "大野営地（ランダム）", en: "Main Camp (Random)" } },
        { pos: 4, suit: "H", rank: "5", name: { zh: "遺跡（隨機）", ja: "遺跡（ランダム）", en: "Ruins (Random)" } },
        { pos: 5, suit: "H", rank: "9", name: { zh: "封牢（隨機）", ja: "封牢（ランダム）", en: "Sealed Prison (Random)" } },
        { pos: 6, suit: "C", rank: "J", name: { zh: "砦（隨機）", ja: "砦（ランダム）", en: "Fort (Random)" } },
      ],
      note: {
        zh: "【不確定】原書265-266頁的「出發地點」與「黃金樹的帳」兩張卡花色皆判讀為黑桃A，但依其他副本的慣例出發／結束花色通常不同，此處可能有誤讀，請對照原書265-266頁確認結束地點的實際花色。",
        ja: "【未確認】原書265〜266頁の「出発地点」と「黄金樹の帳」の2枚は、どちらもスートを黒桃（♠）Aと判読したが、他の副本では出発／終了のスートが異なるのが通例のため、この部分は誤読の可能性がある。原書265〜266頁を参照し、終了地点の実際のスートを確認すること。",
      },
    },
  ];
